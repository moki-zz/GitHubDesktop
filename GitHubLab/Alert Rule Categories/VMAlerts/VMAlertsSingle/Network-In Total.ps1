...
# Define variables
$alertRuleNamePrefix = "VM - Network - In Total - azm "
...
foreach ($vm in $vms) {
    try {
        ...
        $description = "Client Name:$Customer - Measures the rate of data transfer in bytes per second for network interface (network adapter) on a Windows system"
